...
const encodeBinaryNodeWorker = async ({ tag, attrs, content }, opts = constants, buffer = [0]) => {
    ...
    if (typeof content === 'string') {
        ...
        for (const item of content) {
            await encodeBinaryNodeWorker(item, opts, buffer);
        }
...
module.exports = { encodeBinaryNodeWorker };